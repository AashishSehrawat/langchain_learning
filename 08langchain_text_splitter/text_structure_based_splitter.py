# we are gonna use the Recursive Character Text Splitter.
# first it divide the text on:
#   paragraph
#   line
#   word
#   character 
# after the splitting the it trying to add the splitted text as the added text lies in chunk_size
